...
- Raw-source retention for replay and debugging
- JSONL decision logging for every fetch, attempt, and escalation
...
Every decision is written to `logs/decisions.jsonl`, including:
